# Don't Remove Credit @movies_bangla_official
# Subscribe YouTube Channel For Amazing Bot @sumangayenyt
# Ask Doubt on telegram @movies_bangla_official
...
# Bot information
SESSION = environ.get('SESSION', 'suman_only')
...
PICS = (environ.get('PICS', 'https://envs.sh/MtN.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6328044100').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6328044100').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002380079182').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002264280958') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002261425029')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002380079182')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002356637436').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movie1:movie1@movie1.ifhuc.mongodb.net/?retryWrites=true&w=majority&appName=movie1")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_request1234')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movies_request1234')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movies_request1234') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@suman_only')
...
LANGUAGES = ["malayalam", "mal", "bengali","tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan"]
